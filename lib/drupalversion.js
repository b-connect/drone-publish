...
var DrupalVersion = function(string) {
    ...
    if (typeof this.initialVersion === 'object' && this.initialVersion['$t']) {
        this.initialVersion = this.version = this.initialVersion['$t'];
    }
    this.valid = false;
...
DrupalVersion.prototype.gt = function (version) {
    try {
      if ( semver.valid(version) === null || semver.valid(this.version) === null) {
        ...
        console.log('Wrong version', this.version, version);
        return false;
    }
}
